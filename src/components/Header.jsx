...
useEffect(() => {
  ...
  return (
    <div className=' fixed flex items-center justify-end w-full z-10 py-20 px-20'>
      <button id='top-btn' className='bg-[#02090F] px-4 py-2 hover:bg-white hover:scale-110 mr-2 transition-all duration-300 hover:text-black  rounded-full text-white text-xl '>Download CV <i className="ri-download-fill"></i></button>
